function submitButtonHandler(e) {
	...
	if (document.getElementById("form").value == "add") {
		...
		if (e.data.objId == 'submitMovie' || e.date.validate) {
			e.preventDefault();
...
$('mform').submit(function(e){
	...
	$('#movieModal').on({ 'hidden.bs.modal': modalHandler }, { 'objId': 'movieModal', 'validate': validateForm()});
