            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="{{route('certificate.index')}}">Certificates</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="{{route('role.index')}}">Roles</a>
                      </li>
<!--                       <li class="nav-item">
                        <a class="nav-link" href="{{route('movie_producer.index')}}">Movie & Producer</a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link" href="{{route('movie_actor_role.index')}}">Movie & Actor Roles</a>
                      </li> -->
                    </ul>
